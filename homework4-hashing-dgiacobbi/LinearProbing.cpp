 ...
 * @brief Functions that define a linear probing hash table, including insert, delete, rehash, and find.
 * @version 1.0
 * @date 2022-10-18
 */
...
class LinearProbing : public Hash{
    ...
    public:
        ...
        /*************************************************************
        * Function: LinearProbing(std::vector<std::string> & vec)
        ...
        * Date Created: 10/18/22
        * Date Last Modified: 10/30/22
        * Description: use linear probing to insert item into hash table
        * Input parameters: string of value being added to table,
        ...
        *************************************************************/
        void insertItem(std::vector<std::string> & vec, std::string str){
            ...
            // Linear Probe through the rest of the table
            for (int i = 0; i < vec.size(); i++){

                key = (key + i) % getTableSize();
        ...
        *************************************************************/
        void removeItem(std::vector<std::string> & vec, std::string str){
            ...
            // Linear Probe from hash key until item is reached
            for (int i = 0; i < vec.size(); i++){
        ...
        *************************************************************/
        bool findItem(std::vector<std::string> & vec, std::string str){
            ...
            // Linear Probe hash table until item is found or return false
            for (int i = 0; i < vec.size(); i++){
        ...
        *************************************************************/
        void rehash(std::vector<std::string> & vec){
            ...
            for (int i = 0; i < vec.size(); i++){
                ...
                // Linear probe the new hash table, adding elements to next available spots
                for (int j = 0; j < newVec.size(); j++){

                    key = (key + j) % newVec.size();
